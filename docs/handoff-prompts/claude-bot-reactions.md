...
Paste this into a Claude Code session running in your Claude bot's repo (e.g. `~/claude-agents/<bot-name>`). It tells Claude what to build and how, mirrored on the Gemma implementation in `~/repos/gem-discord-bot`.

---

## Prompt to paste

I want to add reaction-driven actions to this Discord bot. The Gemma bot at `~/repos/gem-discord-bot` already has this feature — read its design doc at `~/repos/gem-discord-bot/docs/superpowers/specs/2026-04-24-reaction-driven-actions-design.md` and its plan at `~/repos/gem-discord-bot/docs/superpowers/plans/2026-04-24-reaction-driven-actions.md` for full context. Then implement the equivalent in this repo, adapting to its language/runtime.
