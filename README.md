...
- **Agent Handoff:** Give Gemma the ability to delegate specific sub-tasks to other local CLI tools or external webhooks (e.g., triggering code reviews via `code-review-tool`).
